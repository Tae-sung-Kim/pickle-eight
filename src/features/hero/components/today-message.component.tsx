...
import { useGptTodayMessageQuery } from '@/features/hero/queries/use-gpt-today-message.query';
import { MessageStateType } from '@/features/quiz/types/openai-api.type';
import {
  getCachedData,
  getKoreaTime,
  getTodayString,
...
import { getTimeSlot } from '@/features/hero/utils/today-message.util';
import { useCallback, useEffect, useMemo, useState } from 'react';
import { buildHeroCards } from '@/features/hero/components/hero-cards.builder';
import { MessageCardComponent } from '@/features/hero/components/message-card.component';
