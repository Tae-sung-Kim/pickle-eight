    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      ...
      >
        <Button
          ...
          size="lg"
          variant="outline"
          className={`w-full py-6 text-lg font-medium transition-all duration-200 rounded-lg border-2 ${
            isDrawing
              ? 'border-gray-300 text-gray-400 bg-gray-50 cursor-not-allowed'
              : 'border-primary text-primary hover:bg-primary/5 hover:border-primary/80 active:bg-primary/10'
          }`}
        >
          {isDrawing ? (
            <span className="flex items-center justify-center gap-2">
              ...
              <span className="font-medium">뽑는 중...</span>
            </span>
          ) : allParticipantsDrawn ? (
            <span className="flex items-center justify-center gap-2 group">
              <Sparkles className="w-5 h-5 text-yellow-400 transition-transform duration-300 group-hover:rotate-12" />
              <span className="font-semibold">다시하기</span>
            </span>
          ) : (
            <span className="flex items-center justify-center gap-2 group">
              <Sparkles className="w-5 h-5 text-yellow-400 transition-transform duration-300 group-hover:animate-pulse" />
