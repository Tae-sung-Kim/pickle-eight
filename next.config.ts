...
const csp = [
  ...
  "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.applixir.com https://pagead2.googlesyndication.com https://t1.daumcdn.net https://*.kakaocdn.net https://*.daumcdn.net https://imasdk.googleapis.com https://securepubads.g.doubleclick.net https://sdk.privacy-center.org https://s0.2mdn.net",
  // Some browsers consult script-src-elem separately
  "script-src-elem 'self' 'unsafe-inline' https://cdn.applixir.com https://pagead2.googlesyndication.com https://t1.daumcdn.net https://*.kakaocdn.net https://*.daumcdn.net https://imasdk.googleapis.com https://securepubads.g.doubleclick.net https://sdk.privacy-center.org https://s0.2mdn.net",
  ...
  "media-src 'self' blob: data: https://cdn.applixir.com",
